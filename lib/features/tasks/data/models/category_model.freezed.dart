...
class _$CategoryModelImpl implements _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, display_name: $display_name, icon: $icon, color: $color, created_at: $created_at)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, display_name, icon, color, created_at);
